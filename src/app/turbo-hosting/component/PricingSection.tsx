                  ...
                  <div className="mb-6">
                    ...
                    {plan.title === "Starter" && (
                      <div className="bg-gray-100 rounded-lg p-3 relative group">
                        ...
                        {/* Tooltip */}
                        <div className="absolute left-0 top-full mt-2 z-50 w-80 bg-blue-600 text-white text-sm md:text-lg rounded-lg p-3 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
