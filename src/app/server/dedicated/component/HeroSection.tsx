    ...
    >
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between pt-8 md:pt-0">
        ...
        <div className="flex-1 text-white lg:pr-12 text-center lg:text-left mb-8 lg:mb-0">
          ...
          <button onClick={() => router.push("/contact")} className="text-white font-semibold px-8 py-3 rounded transition text-base sm:text-lg shadow w-full sm:w-auto mb-6 sm:mb-10 hover:shadow-lg" style={{ fontFamily: '"Urbanist", sans-serif', background: 'linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%)' }}>
