...
import pricingPlans from "../data/turboData";
...
const planLinks = {
  monthly: {
    starter: "https://my.hostnin.com/index.php/store/turbo-hosting/cloud-starter",
  ...
  yearly: {
    starter: "https://my.hostnin.com/index.php/store/turbo-hosting/cloud-starter?billingcycle=annually",
    pro: "https://my.hostnin.com/index.php/store/turbo-hosting/professional?billingcycle=annually",
    ultimate: "https://my.hostnin.com/index.php/store/turbo-hosting/ultimate?billingcycle=annually"
  }
};

const TurboHostingPrice = () => {
...
export default TurboHostingPrice;