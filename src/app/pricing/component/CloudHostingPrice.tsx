...
import pricingPlans from "../data/cloudData";
...
const planLinks = {
  monthly: {
    ...
    starter: "https://my.hostnin.com/index.php/store/cloud-hosting/cloud-starter",
  ...
  yearly: {
    basic: "https://my.hostnin.com/index.php/store/cloud-hosting/basic?billingcycle=annually",
    starter: "https://my.hostnin.com/index.php/store/cloud-hosting/cloud-starter?billingcycle=annually",
    pro: "https://my.hostnin.com/index.php/store/cloud-hosting/professional?billingcycle=annually",
    ultimate: "https://my.hostnin.com/index.php/store/cloud-hosting/ultimate?billingcycle=annually"
  }
};
...
// Add this function to get the plan link
...
const CloudHostingPrice = () => {
  ...
  return (
    <section
      className="pricing-scroll w-full flex flex-col items-center justify-center py-8 sm:py-10  bg-[#f8f8f8] pt-8  px-4 sm:px-6 md:py-14"
            ...
            >
              ...
              <div className="flex flex-col justify-between px-6 py-6 w-full h-full">
                ...
                <div className="text-center mb-8">
                  ...
                  <a
                    href={getPlanLink(plan.title, billing)} // Fixed: Pass billing parameter
                    target="_blank"
                            ...
                            <div key={category} className="mt-6">
                              ...
                              {plan.expandedFeatures &&
                                ...
                                plan.expandedFeatures[category].map(
                                  (feature: { text: string; included?: boolean; tooltip?: string }, i: number) => (
                                    <div
                                      key={`${category}-${i}`}
...
export default CloudHostingPrice;