...
const planLinks = {
  monthly: {
    starter: "https://my.hostnin.com/index.php/store/bdix-hosting/cloud-starter",
  ...
  yearly: {
    starter: "https://my.hostnin.com/index.php/store/bdix-hosting/cloud-starter?billingcycle=annually",
    pro: "https://my.hostnin.com/index.php/store/bdix-hosting/professional?billingcycle=annually",
    ultimate: "https://my.hostnin.com/index.php/store/bdix-hosting/ultimate?billingcycle=annually"
  }
};

const BdixHostingPrice = () => {
...
export default BdixHostingPrice;