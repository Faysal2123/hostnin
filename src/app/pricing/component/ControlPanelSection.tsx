      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center border-b border-gray-200 mb-8">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              className={`py-3 px-4 sm:px-6 m-1 text-sm sm:text-2xl font-medium transition-colors duration-200 rounded cursor-pointer ${
                activeTab === tab.id
        ...
        <div className="flex flex-col lg:flex-row bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8 mb-8">
          ...
          <div className="lg:w-1/2 lg:pr-8 space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-4">
              {currentContent.features.map((feature, index) => (
                <div
                  key={index}
                  className="p-4 sm:p-5 rounded-lg bg-gray-50 border border-gray-100 transform transition-transform duration-300 hover:-translate-y-1"
                >
          ...
          <div className="lg:w-1/2 mt-6 lg:mt-0 flex items-center justify-center">
            <div className="w-full max-w-full sm:max-w-2xl h-auto rounded-lg overflow-hidden flex items-center justify-center">
              <Image
