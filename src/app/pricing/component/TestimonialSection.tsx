...
const TestimonialSection = () => (
  <section className="flex flex-col lg:flex-row justify-center items-center gap-6 sm:gap-8 py-8 md:pb-16 px-4 sm:px-6 bg-[#f8f8f8]" style={{ fontFamily: '"Mulish", sans-serif' }}>
    {/* Left Side */}
