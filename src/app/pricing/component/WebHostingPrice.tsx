...
import pricingPlans from "../data/webData";
...
const planLinks = {
  ...
  yearly: {
    starter: "https://my.hostnin.com/index.php/store/web-hosting/starter?billingcycle=annually",
    pro: "https://my.hostnin.com/index.php/store/web-hosting/professional?billingcycle=annually",
    ultimate: "https://my.hostnin.com/index.php/store/web-hosting/ultimate?billingcycle=annually"
  }
};
...
const WebHostingPrice = () => {
  ...
  return (
    <section
      className="pricing-scroll w-full flex flex-col items-center justify-center py-6 sm:py-8 md:py-14  bg-[#f8f8f8] pt-8 px-3 sm:px-6"
                ...
                <div className="w-full mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    {showExpandedFeatures && plan.expandedFeatures && (
                      <>
                        {(["primary", "server", "security", "support"] as const).map((category) => (
