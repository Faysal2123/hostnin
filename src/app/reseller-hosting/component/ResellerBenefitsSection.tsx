...
const ResellerBenefitsSection = () => {
  return (
    <section className="bg-[#f8f8f8] py-8 sm:py-12 md:py-16 pt-[1290px] sm:pt-[250px] md:pt-[300px] lg:pt-[450px] md:px-4 px-2">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-start">
        ...
        <div>
          <h2 className="text-[26px] sm:text-3xl md:text-4xl font-bold text-[#001858] mb-3 sm:mb-4 leading-tight">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 pb-8 w-full transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
            ...
            <p className="text-[#6b7280] text-[15px] sm:text-base w-full text-justify">{benefits[0].description}</p>
          </div>
        </div>
        {/* Right: Two stacked cards */}
        <div className="flex flex-col gap-6 sm:gap-8">
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
            <div className="flex items-center gap-4 sm:gap-6 mb-3">
              <div className="flex-shrink-0">
                <Image
            ...
            <p className="text-[#6b7280] text-[15px] sm:text-base w-full text-justify">{benefits[1].description}</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6 sm:p-6 md:p-8 transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer">
            <div className="flex items-center gap-4 sm:gap-6 mb-3 ">
              <div className="flex-shrink-0">
                <Image
            ...
            <p className="text-[#6b7280] text-[15px] sm:text-base w-full text-justify">{benefits[2].description}</p>
          </div>
        </div>
      </div>
    </section>
