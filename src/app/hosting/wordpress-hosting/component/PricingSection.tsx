...
// Define the links from the image
const planLinks = {
  monthly: {
    starter: "https://my.hostnin.com/index.php/store/wordpress-hosting/wp-starter",
    pro: "https://my.hostnin.com/index.php/store/wordpress-hosting/professional",
    ultimate: "https://my.hostnin.com/index.php/store/wordpress-hosting/ultimate",
  },
  yearly: {
    starter: "https://my.hostnin.com/index.php/store/wordpress-hosting/wp-starter?billingcycle=annually",
    pro: "https://my.hostnin.com/index.php/store/wordpress-hosting/professional?billingcycle=annually",
    ultimate: "https://my.hostnin.com/index.php/store/wordpress-hosting/ultimate?billingcycle=annually",
  },
};
...
const PricingSection = () => {
  ...
  const getPlanLink = (planTitle: string) => {
    // Extract the key from the plan title (remove "WP " prefix)
            ...
            >
              ...
              <div className="flex flex-col justify-between px-4 sm:px-6 py-4 sm:py-6 w-full h-full">
                ...
                <div className="w-full mb-8">
                  ...
                  <h4 className="font-bold text-gray-800 mb-4 text-lg md:text-xl">
                    Features
                  </h4>
                ...
                {!showExpandedFeatures ? (
                  ...
                  >
                    ...
                    <IoMdArrowDropdown
                      size={18}
                      className="text-blue-600 hover:scale-105 transition-transform duration-200"
                    />
                  </div>
                ) : (
                  <div
