      ...
      <div className="z-20">
        ...
        <div className="flex items-center gap-2 mt-2">
          ...
          <span className="ml-2 sm:ml-4 text-[#2B4EFF] text-[15px] md:text-base font-bold cursor-pointer flex items-center underline" style={{ fontFamily: '"Mulish", sans-serif' }}>
            ...
            />
            <Link target="_blank" href="https://www.google.com/search?q=hostnin&oq=hostnin&gs_lcrp=EgZjaHJvbWUqDwgAECMYJxjjAhiABBiKBTIPCAAQIxgnGOMCGIAEGIoFMgYIARBFGDwyBggCEEUYQTIGCAMQRRg8MhIIBBAuGCcYrwEYxwEYgAQYigUyBggFEEUYPDIGCAYQRRg8MgYIBxBFGEHSAQgxODQzajBqNKgCALACAQ&sourceid=chrome&ie=UTF-8#lrd=">More Review</Link>
