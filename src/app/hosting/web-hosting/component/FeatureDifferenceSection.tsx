...
const CloudFeatureDifference = () => {
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-3 sm:px-4 pt-8 sm:pt-48 lg:pt-52 pb-16 sm:pb-24 lg:pb-24 relative z-10" style={{ minHeight: '700px' }}>
        {/* Left: Image */}
        ...
        <div className="flex-1 flex flex-col items-start justify-center w-full md:pl-2 md:mt-6 lg:mt-10">
          <h2 className="text-[26px] sm:text-3xl md:text-[2.8rem] leading-[1.1] font-bold text-black mb-3 sm:mb-4 text-left font-['Urbanist',sans-serif]">
            What makes Hostnin <br />
            different from others?
          </h2>
          <p className="mb-6 sm:mb-8 lg:mb-10 text-gray-700 max-w-2xl text-left text-[15px] md:text-base lg:text-lg font-normal font-['Mulish',sans-serif]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full">
            {featureDifferenceData.map((feature, idx) => (
              <div
                key={idx}
                className="flex flex-col items-start bg-white rounded-2xl p-4 py-5 sm:p-4 lg:p-5 h-full min-h-[140px] sm:min-h-[160px] lg:min-h-[180px] border border-[#eaf4fd] shadow-xl"
              ...
              >
                ...
                <h3 className="font-bold text-lg sm:text-lg text-black mb-1 sm:mb-2 text-left font-['Urbanist',sans-serif] py-1">{feature.title}</h3>
                <p className="text-gray-700 text-[15px] md:text-base text-left font-normal font-['Mulish',sans-serif]">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
