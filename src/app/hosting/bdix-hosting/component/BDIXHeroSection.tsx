...
const BDIXHeroSection = () => {
  return (
    <section className="bg-[#f8f8f8] px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 md:pt-10 pb-8 ">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 relative">
        ...
        <div className="flex-1 max-w-xl text-center lg:text-left order-2 lg:order-1">
          ...
          <p className="text-[#232946] text-[15px] sm:text-base mb-6 sm:mb-8 leading-relaxed text-justify">
          ...
          <button onClick={() => {
              ...
              }} className="bg-[#1769ff] hover:bg-[#0a3ec9] text-white font-semibold px-6 sm:px-8 py-2.5 sm:py-3 rounded-sm transition text-[15px] sm:text-base shadow mb-4 w-full sm:w-auto cursor-pointer">
            Order Now
          </button>
        </div>
        {/* Right Side */}
