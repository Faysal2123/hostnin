  ...
  return (
    <div className='bg-[#f8f8f8] pb-12 sm:pb-16 lg:pb-20'>
      ...
      <div className="flex-1 lg:pr-8 xl:pr-16">
        <h2 className="text-2xl md:text-xl lg:text-3xl font-bold text-gray-800 mb-2 sm:mb-3 font-['Urbanist',sans-serif]">
        ...
        <p className="text-gray-600 text-[15px] sm:text-sm lg:text-base leading-relaxed mb-6 sm:mb-8 max-w-lg font-['Mulish',sans-serif]">
        ...
        <ul className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
          <li className="flex items-start gap-2 sm:gap-3 text-gray-700 font-['Mulish',sans-serif]">
            <MdCheckCircle className="text-blue-500 w-5 h-5 sm:w-5 sm:h-5 mt-0.5 sm:mt-1 flex-shrink-0" />
            <span className="text-sm sm:text-sm lg:text-base">PHP-FPM Advanced Process Management with Dedicated Opcache Performance</span>
          </li>
          <li className="flex items-start gap-2 sm:gap-3 text-gray-700 font-['Mulish',sans-serif]">
            <MdCheckCircle className="text-blue-500 w-5 h-5 sm:w-5 sm:h-5 mt-0.5 sm:mt-1 flex-shrink-0" />
            <span className="text-sm sm:text-sm lg:text-base">One-Click Gmail and Office 365 DNS Setup</span>
          </li>
          <li className="flex items-start gap-2 sm:gap-3 text-gray-700 font-['Mulish',sans-serif]">
            <MdCheckCircle className="text-blue-500 w-5 h-5 sm:w-5 sm:h-5 mt-0.5 sm:mt-1 flex-shrink-0" />
            <span className="text-sm sm:text-sm lg:text-base">Load Balanced & Redundant Platform</span>
          </li>
        </ul>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button  
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold cursor-pointer px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg transition-colors text-[15px] sm:text-base font-['Mulish',sans-serif]">
            See Pricing
          </button>
          {/* <button className="text-gray-700 hover:text-blue-500 underline font-semibold cursor-pointer px-4 sm:px-6 lg:px-8 py-2 sm:py-3 transition-colors text-[15px] sm:text-base font-['Mulish',sans-serif]">
           16+ CDN Location
          </button> */}
        </div>
      </div>
