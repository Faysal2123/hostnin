  ...
  return (
    <section className="bg-gray-50 py-8 sm:py-10 lg:py-12">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        ...
        <p className="text-center text-gray-500 mb-6 sm:mb-8 lg:mb-10 text-[15px] sm:text-base px-3 sm:px-4">
          ...
          {guides.map((guide, idx) => (
            ...
            >
              ...
              <div className="p-5 sm:p-4 lg:p-5 flex flex-col flex-1">
                ...
                target="_blank"
                  href={guide.link}
                  className="mt-auto text-base text-gray-700 font-medium hover:text-orange-500 hover:underline flex items-center gap-1 transition-colors duration-200"
                >
