...
export const comparisonTableData: ComparisonTableData = {
  plans: [
    { name: "Basic", price: 999, priceUnit: "/year", orderLink: "https://my.hostnin.com/index.php/store/cloud-hosting/basic?billingcycle=annually" },
    { name: "Starter", price: 2150, priceUnit: "/year", orderLink: "https://my.hostnin.com/index.php/store/cloud-hosting/cloud-starter?billingcycle=annually" },
    { name: "Professional", price: 2999, priceUnit: "/year", orderLink: "https://my.hostnin.com/index.php/store/cloud-hosting/professional?billingcycle=annually" },
    { name: "Ultimate", price: 2999, priceUnit: "/year", orderLink: "https://my.hostnin.com/index.php/store/cloud-hosting/ultimate?billingcycle=annually" },
  ],
  sections: [
    {
