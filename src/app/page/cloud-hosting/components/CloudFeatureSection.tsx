    ...
    <div className='bg-[#f8f8f8] pb-12 sm:pb-16 lg:pb-20'>
      ...
      <div className="flex-1 lg:pr-8 xl:pr-16">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold cursor-pointer px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-lg transition-colors text-[15px] sm:text-base font-['Mulish',sans-serif]">
            Sign Up
          </button>
          <button className="text-gray-700 hover:text-blue-500 font-semibold cursor-pointer px-4 sm:px-6 lg:px-8 py-2 sm:py-3 transition-colors text-[15px] sm:text-base font-['Mulish',sans-serif]">
            Compare Pricing
          </button>
        </div>
      </div>
