...
const tabClass = (active: boolean) =>
  `px-3 sm:px-4 md:px-6 py-1 font-semibold text-sm md:text-base focus:outline-none transition-colors duration-200 rounded-full ${
...
const PricingSection = () => {
  ...
  return (
    <section id="pricing-section" data-section="pricing" className="pricing-scroll w-full flex flex-col items-center justify-center py-8 sm:py-10 md:py-14 lg:py-20 bg-[#f8f8f8] pt-8 md:pt-[500px] lg:pt-60 px-4 sm:px-6" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      <div className="w-full max-w-7xl">
        <h2 className="pb-3 text-[25px] md:text-4xl lg:text-5xl font-bold text-[#232946] mb-2  md:mb-4 text-center " style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
