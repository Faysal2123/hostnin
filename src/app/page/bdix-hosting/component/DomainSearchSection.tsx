...
export default function DomainSearchSection() {
  return (
    <div className='bg-[#f8f8f8] py-12'>
      <div className="bg-white rounded-2xl shadow-lg md:px-8 py-5 px-4 flex items-center justify-between gap-8 max-w-7xl mx-auto">
        {/* Left: Search and Prices */}
        <div className="flex-1">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0A1440] mb-6">
            Search your Domain Name
          </h2>
          <form className="flex mb-6 max-w-full sm:max-w-md md:max-w-xl">
            <input
              type="text"
              placeholder="yourdomain.com"
              className="flex-1 px-3 py-3 sm:px-4 sm:py-4 bg-[#F3F3F5] text-base outline-none border-none"
            />
            <button
              type="submit"
              className="flex items-center gap-2 bg-gradient-to-r from-[#0A8AFF] to-[#3B82F6] text-white font-semibold text-base px-4 sm:px-8 rounded-r-sm hover:opacity-90 transition"
            >
