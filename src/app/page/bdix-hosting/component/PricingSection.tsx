  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl">
        <h2
        id="pricing-section"
          className="text-[25px] md:text-4xl lg:text-5xl font-bold text-slate-700 mb-5 md:mb-6 text-center"
          style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
        >
        ...
        <div className="flex flex-row items-center gap-4 mb-8 justify-center">
          ...
          >
            ...
            <span
              className="text-blue-400 font-medium text-base md:text-lg inline ml-10"
              style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
            >
              Upto 76% save
            </span>
        ...
        <div className="w-full flex flex-col lg:flex-row gap-10 sm:gap-8 md:gap-10 justify-center items-start mt-8 sm:mt-12 md:mt-16">
          {plans.map((plan) => (
            ...
            >
              ...
              {plan.badge && (
                <div
                  className="absolute -top-5 md:-top-7.5 md:right-20 right-24 bg-gradient-to-r from-red-500 to-orange-500 text-white text-xs font-bold md:px-14 px-7 py-1.5 rounded-full shadow md:text-base"
                  style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
                >
                  {plan.badge}
                </div>
              ...
              <div className="flex flex-col justify-between px-4 sm:px-6 py-4 sm:py-6 w-full h-full">
                ...
                <div className="text-center mb-8">
                  ...
                  {plan.savingsText && (
                    <div
                      className="bg-gradient-to-r from-green-50 to-blue-50 text-green-700 font-bold text-sm md:text-base mb-6 px-4 py-2 rounded-full border border-green-200 inline-block shadow-sm"
                      style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
                    >
                      {plan.savingsText}
                    </div>
                ...
                <div className="w-full mb-8">
                    ...
                    {plan.title === "Starter" && (
                      ...
                      >
                       ...
                       <div className="flex items-center gap-1">
                          ...
                          <p className="text-gray-500 text-xs underline decoration-dotted md:text-xs">
                  ...
                  <h4
                    className="font-bold text-gray-800 mb-4 text-sm text-lg md:text-xl"
                    style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
                  >
                    Features
                  </h4>
                  <div className="space-y-3">
                    ...
                    {showExpandedFeatures && plan.expandedFeatures && (
                      <>
                        {(["general", "server", "security", "support"] as const).map(
                          (category) => (
                            <div key={category} className="mt-6">
                              <h5
                                className="font-bold text-gray-800 mb-3 text-lg capitalize bg-gray-50 px-3 py-2 rounded-lg"
                                style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}
                              >
                                {category}
                              </h5>
