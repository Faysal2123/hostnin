...
const tabClass = (active: boolean) =>
  `px-3 sm:px-4 md:px-6 py-1 font-semibold text-sm sm:text-sm md:text-base focus:outline-none transition-colors duration-200 rounded-full ${
...
const PricingSection = () => {
  ...
  return (
    <section id="pricing-section" className="pricing-scroll w-full flex flex-col items-center justify-center py-6 sm:py-8 md:py-14 lg:py-20 bg-[#f8f8f8] ] pt-8  md:pt-[550px] lg:pt-60 px-3 sm:px-6" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
      <div className="w-full max-w-7xl">
        <h2 className="text-[25px]  md:text-4xl lg:text-5xl font-bold text-[#232946] mb-5  md:mb-4 text-center " style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>
        ...
        <div className="flex  flex-row items-center gap-4 mb-8 justify-center">
          ...
          <div className="relative flex items-center -ml-3 mt-3 sm:mt-0" style={{ minWidth: 120 }}>
            ...
            <span className="text-blue-400 font-medium text-base sm:text-base inline ml-10" style={{ fontFamily: '"Plus Jakarta Sans", sans-serif' }}>Upto 76% save</span>
          </div>
        </div>
