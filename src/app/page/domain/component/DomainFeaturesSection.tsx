    ...
    <section className="md:py-16  py-8 bg-[#f8f8f8]">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-20">
            ...
            <h1 className="md:text-4xl text-2xl text-center md:text-start font-bold text-blue-900 mb-6 font-['Urbanist',sans-serif]">
        ...
        <div className="grid lg:grid-cols-2 md:gap-12  items-center  mb-20">
          ...
          {/* Text Content */}
          <div>
            <h2 className="md:text-4xl text-2xl text-center md:text-start font-bold text-blue-900 mb-6 font-['Urbanist',sans-serif]">
              DNS Management
            </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Text Content */}
          <div>
            <h2 className="md:text-4xl text-2xl text-center md:text-start font-bold text-blue-900 mb-9 font-['Urbanist',sans-serif]">
